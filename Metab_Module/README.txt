...
The class has 4 methods: a constructor, __init__, predict_to_prob, predict, and a class prediction method, predict_to_class.
...
predict_to_prob(self, age, waist, systolic):
...
Prediction function that takes a patient's age, waist circumference in centimeter and systolic blood presure in mm/hg
and returns True or False based on the probability that a candidate is at risk of metabolic syndrome.
